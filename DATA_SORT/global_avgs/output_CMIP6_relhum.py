...
for index, modname in models.iteritems():
    ...
    dat = xr.open_dataset(datpath+"vaporpressures_"+modname+".nc").relhum
    ...
    dat = xr.merge([dat_all, dat_ocean, dat_land, dat_arid, dat_humid, dat_hyperarid])
...
cmip6.to_netcdf(pathout+'CMIP6_relhum.nc')
