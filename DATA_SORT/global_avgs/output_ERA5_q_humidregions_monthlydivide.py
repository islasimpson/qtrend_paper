...
era5_monthly = ( (era5_monthly - era5_clim) / era5_clim)*100.
...
era5_aridm = (era5_arid*dayweights_arid).mean('time') / dayweights_arid.sum('time')
era5_humidm = (era5_humid*dayweights_humid).mean('time') / dayweights_humid.sum('time')
...
era5_aridm_avg.to_netcdf(pathout+'humidregions_arid_humid_halfyears.nc')
era5_humidm_avg.to_netcdf(pathout+'humidregions_arid_humid_halfyears.nc', mode='a')
