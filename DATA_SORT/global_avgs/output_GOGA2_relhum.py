...
goga2 = xr.open_mfdataset(basepath+"*.nc", combine='nested', concat_dim='M').relhum
...
dat = xr.merge([goga2_all, goga2_ocean, goga2_land, goga2_arid, goga2_humid, goga2_hyperarid])

dat.to_netcdf(pathout+'GOGA2_relhum.nc')
