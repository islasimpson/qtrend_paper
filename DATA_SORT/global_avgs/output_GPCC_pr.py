...
era5 = xr.open_dataset("/project/cas/islas/python_savs/qtrend_paper/DATA_SORT/OBS/precip/GPCC.nc").sel(time=slice("1980-01","2020-12")).pr
...
dat = xr.merge([era5_land, era5_arid, era5_humid, era5_hyperarid])

dat.to_netcdf(pathout+'GPCC_pr.nc')
