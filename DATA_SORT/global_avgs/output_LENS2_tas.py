...
lens2 = xr.open_mfdataset(basepath+"*.nc", combine='nested', concat_dim='M').TREFHT
...
lens2_ocean_60sn = avg.cosweightlonlat(lens2*oceanfrac,0,360,-60,60)
...
lens2_ocean_60sn = lens2_ocean_60sn.rename('ocean_60sn')
...
dat = xr.merge([lens2_all, lens2_ocean, lens2_ocean_60sn, lens2_land, lens2_arid, lens2_humid, lens2_hyperarid])

dat.to_netcdf(pathout+'LENS2_tas.nc')
