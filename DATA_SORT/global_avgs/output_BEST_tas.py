...
era5 = xr.open_dataset("/project/cas/islas/python_savs/qtrend_paper/DATA_SORT/OBS/tas/BEST_1980_2020.nc").sel(time=slice("1980-01","2020-12")).tas
...
dat.to_netcdf(pathout+'BEST_tas.nc')
