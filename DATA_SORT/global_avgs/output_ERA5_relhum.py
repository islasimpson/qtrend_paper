...
era5 = xr.open_dataset("/project/cas/islas/python_savs/qtrend_paper/DATA_SORT/OBS/vaporpressures/vaporpressures_ERA5.nc").sel(time=slice("1980-01","2020-12")).relhum
...
dat = xr.merge([era5_all, era5_ocean, era5_land, era5_arid, era5_humid, era5_hyperarid])

dat.to_netcdf(pathout+'ERA5_relhum.nc')
