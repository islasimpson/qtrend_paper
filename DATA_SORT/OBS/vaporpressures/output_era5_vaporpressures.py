...
qrel.to_netcdf(pathout+'vaporpressures_ERA5.nc')
svp.to_netcdf(pathout+'vaporpressures_ERA5.nc', mode='a')
vp.to_netcdf(pathout+'vaporpressures_ERA5.nc', mode='a')
vpd.to_netcdf(pathout+'vaporpressures_ERA5.nc', mode='a')
t2m.to_netcdf(pathout+'vaporpressures_ERA5.nc', mode='a')
q.to_netcdf(pathout+'vaporpressures_ERA5.nc', mode='a') 
