...
t2m = isd.t2m
dewp = isd.dewp
t2m = t2m.where(isd.nperday_t2m >= 15, nan)
dewp = dewp.where(isd.nperday_dew >= 15, nan)
isd['t2m'] = t2m
isd['dewp'] = dewp
...
qrel.to_netcdf(pathout+'vaporpressures_ISD_fromhourly_ge15pd.nc')
svp.to_netcdf(pathout+'vaporpressures_ISD_fromhourly_ge15pd.nc', mode='a')
vp.to_netcdf(pathout+'vaporpressures_ISD_fromhourly_ge15pd.nc', mode='a')
vpd.to_netcdf(pathout+'vaporpressures_ISD_fromhourly_ge15pd.nc', mode='a')
lon.to_netcdf(pathout+'vaporpressures_ISD_fromhourly_ge15pd.nc', mode='a')
lat.to_netcdf(pathout+'vaporpressures_ISD_fromhourly_ge15pd.nc', mode='a')
nbaddays.to_netcdf(pathout+'vaporpressures_ISD_fromhourly_ge15pd.nc', mode='a')
