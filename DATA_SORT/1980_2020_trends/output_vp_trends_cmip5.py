...
cmip6models = pd.read_csv('/home/islas/python/qtrend_paper/DATA_SORT/CMIP5/cmip5csvinfo.csv')
models = cmip6models['Model']
nmems = cmip6models['Nmem']
nmemmax = np.max(cmip6models['Nmem'])

datpath="/project/cas/islas/python_savs/qtrend_paper/DATA_SORT/CMIP5/vapor_pressures/"
...
cmip6dat.to_netcdf(pathout+'vptrends_CMIP5.nc')
