...
dat = dat.sel(time=slice("1980-01-01","2020-12-31")).vp
...
dat_monthly = xr.DataArray(dat_monthly , dims=['year','month','lat','lon'], 
                  coords=[yearvals, np.arange(1,13,1), lat, lon], name='vp')
...
dat_monthly_trend.to_netcdf(pathout+'vptrends_ERA5_monthly.nc')
