...
cmip6models = pd.read_csv('/home/islas/python/qtrend_paper/DATA_SORT/CMIP6/cmip6csvinfo_hus.csv')
models = cmip6models['Model']
nmems = cmip6models['Nmem']
nmemmax = np.max(cmip6models['Nmem'])

datpath="/project/cas/islas/python_savs/qtrend_paper/DATA_SORT/CMIP6/Qprofiles/"
...
for index, modname in models.iteritems():
    ...
    dat = xr.open_dataset(datpath+'Q_sw_'+modname+'.nc')
...
cmip6dat.to_netcdf(pathout+'qprofile_trends_CMIP6.nc')
